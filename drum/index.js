...
document.addEventListener("keypress",function (event){
    makeSound(event.key);//assign key property.
    ...
    case "w":var audio1=new Audio("tom-1.mp3");
     ...
     break;
      case "d":var audio4=new Audio("tom-4.mp3");
                   audio4.play();
     break;
     case "j":var audio5=new Audio("snare.mp3");
                     audio5.play();
     break;
     case "k":var audio6=new Audio("crash.mp3");
                       audio6.play();
      break;
      case "l":var audio7=new Audio("kick-bass.mp3");
                         audio7.play();
      break;
